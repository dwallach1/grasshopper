...
import { deskAuthErrorMessage, firstSearchParam } from '../../lib/auth-search';
...
function SignInForm({
  ...
  const queryError = firstSearchParam(params.get('auth_error') ?? undefined);
  const [error, setError] = useState<string | null>(() => deskAuthErrorMessage(denied, authError ?? queryError));
