...
describe('desk IA smoke', () => {
  ...
  test('product chrome is grasshopper; venue shorts are STOCKS / PREDICTIONS / COINS', async () => {
    ...
    expect(avatarLib).toContain('capsule faces');
    ...
    expect(bots).toContain('data-part="goggle"');
    ...
    expect(bots).toContain('BotStrap');
    ...
    expect(avatarCss).toContain('.strap');
    expect(avatarCss).toContain('.rim');
    expect(avatarCss).toContain('.belly');
