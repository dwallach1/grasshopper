...
describe('desk IA smoke', () => {
  ...
  test('product chrome is grasshopper; venue shorts are STOCKS / PREDICTIONS / COINS', async () => {
    ...
    expect(bots).toContain('data-part="lid"');
    expect(bots).toContain('data-part="mound"');
    expect(bots).toContain('feTurbulence');
    ...
    expect(avatarCss).toContain('.lidRest');
    expect(avatarCss).toContain('.fur');
    expect(avatarCss).toContain('.halo');
    expect(avatarCss).not.toContain('.strap');
    expect(avatarCss).not.toContain('.rim');
    expect(avatarCss).not.toContain('.belly');
