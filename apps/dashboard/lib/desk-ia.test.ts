...
describe('desk IA smoke', () => {
  ...
  test('product chrome is grasshopper; venue shorts are STOCKS / PREDICTIONS / COINS', async () => {
    ...
    expect(avatarLib).toContain('fluff faces');
    expect(avatarLib).toContain('stewardMood');
    expect(avatarLib).toContain('stewardSilhouette');
    ...
    expect(bots).toContain('data-artboard="padded"');
    expect(bots).toContain('<svg');
    expect(bots).toContain('overflow="visible"');
    expect(bots).not.toContain('attachStewardCanvas');
    expect(bots).not.toContain('steward-gl');
    expect(bots).not.toContain('from \'three\'');
    expect(bots).not.toContain('WebGLRenderer');
    expect(bots).not.toContain('feTurbulence');
    expect(bots).not.toContain('BotStrap');
    expect(bots).not.toContain('BotMouth');
    expect(bots).not.toContain('data-part="goggle"');
    ...
    expect(bots).not.toContain('overalls');
    expect(bots).not.toContain('Minion');
    ...
    expect(avatarCss).toContain('steward-bounce');
