...
const REQUIRED: Array<[string, string]> = [
  ...
  ['positions', 'position_episodes?select=id,account_key,symbol,status,quantity,average_cost,opened_at,closed_at,next_review_at,thesis_id&status=in.(proposed,open,closing,closed)&order=opened_at.desc.nullslast,symbol.asc&limit=400'],
