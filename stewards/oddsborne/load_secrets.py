"""Load ODDSBORNE credentials without echoing values. Nothing secret lives in this repo.
...
NAMES = ("POLYMARKET_US_KEY_ID", "POLYMARKET_US_SECRET_KEY", "ODDSBORNE_WORKER_DB_PASSWORD")
